...
x_data, y_data = lfw_people.images, lfw_people.target
...
# Reshape the data
im_rows, im_cols = x_train.shape[1], x_train.shape[2]  # Adjust these dimensions as needed
...
print(classification_report(np.argmax(y_test, axis=1), np.argmax(y_pred, axis=1), zero_division=1, target_names=target_names))
